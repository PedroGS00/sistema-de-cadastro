...
class ProductServiceTest {
    ...
    @Test
    @DisplayName("createProduct: sucesso e normalização de SKU")
    ...
    @Test
    @DisplayName("createProduct: SKU duplicado lança BusinessException")
    ...
    @Test
    @DisplayName("createProduct: preço inválido lança BusinessException")
    ...
    @Test
    @DisplayName("getProductBySku: não encontrado lança ResourceNotFoundException")
    ...
    @Test
    @DisplayName("getAllProducts: paginação delegada ao repositório")
    ...
    @Test
    @DisplayName("updateProduct: sucesso com validações")
    void updateProduct_success() {
        ...
        // SKU deve ser normalizado para upper-case no update
        assertEquals("ABC-123", updated.getSku());
        verify(productRepository).save(any(Product.class));
    }

    @Test
    @DisplayName("deleteProduct: sucesso delegando ao repositório")
    ...
    class StockOperations {
        ...
        @Test
        @DisplayName("updateProductStock: reduz além do disponível lança IllegalStateException")
        ...
        @Test
        @DisplayName("updateStock: quantidade nula/zero lança BusinessException")
        @Disabled("Smoke suite: reduzir cobertura de validações secundárias")
        ...
        @Test
        @DisplayName("updateStock: negativo delega para redução")
    ...
    @Test
    @DisplayName("getLowStockProducts(page): paginação manual correta")
