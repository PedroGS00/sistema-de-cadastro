...
class CepServiceTest {
    ...
    @Test
    @DisplayName("validateAndFetchCep: CEP com tamanho inválido lança BusinessException")
    void validateAndFetchCep_invalidLength() {
        assertThrows(BusinessException.class, () -> cepService.validateAndFetchCep("1234567")); // 7 dígitos
        assertThrows(BusinessException.class, () -> cepService.validateAndFetchCep("123456789")); // 9 dígitos
        assertThrows(BusinessException.class, () -> cepService.validateAndFetchCep("12-34-56")); // normaliza mas tamanho incorreto
    }

    @Test
    @DisplayName("validateAndFetchCep: CEP não encontrado (erro=true) lança BusinessException")
    ...
    @Test
    @DisplayName("validateAndFetchCep: falta de cidade (localidade) lança BusinessException")
    ...
    @Test
    @DisplayName("validateAndFetchCep: logradouro ausente não impede sucesso (apenas warn)")
