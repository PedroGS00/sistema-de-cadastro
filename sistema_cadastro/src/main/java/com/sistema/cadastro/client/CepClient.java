...
@Cacheable(value = "cepData", key = "#cep", unless = "#result == null")
    public CepDataDTO getCepData(String cep) {
        ...
        return webClient
                ...
                .onStatus(HttpStatusCode::is4xxClientError, response -> {
                    ...
                    return Mono.error(new BusinessException("CEP inválido ou não encontrado"));
                })
                .onStatus(HttpStatusCode::is5xxServerError, response -> {
                    log.error("Erro 5xx ao consultar CEP: {}", cep);
                    return Mono.error(new BusinessException("Erro no serviço de consulta de CEP"));
                })
    ...
    public CepDataDTO fallbackCepData(String cep, Exception ex) {
        ...
        // Retorna um CEP inválido para que o serviço possa tratar
